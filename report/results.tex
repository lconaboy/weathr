...
\begin{figure*}
  ...
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=0.85\textwidth]{figures/ndvi_oni_capetown_smoothed_5.png}
    \caption{South Africa}
    \label{fig:ndvi_t_south}
  \end{subfigure}
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=0.85\textwidth]{figures/ndvi_oni_eastafrica_smoothed_5.png}
    \caption{East Africa}
...
2011, this time however NDVI progress out-of-phase climbing to its
