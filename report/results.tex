...
\begin{figure*}
  ...
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=0.85\textwidth]{figures/ndvi_oni_io_capetown_smoothed_5.png}
    \caption{South Africa}
    \label{fig:ndvi_t_south}
  \end{subfigure}
  \begin{subfigure}{\textwidth}
    \centering
    \includegraphics[width=0.85\textwidth]{figures/ndvi_oni_io_xoeastafrica_smoothed_5.png}
    \caption{East Africa}
