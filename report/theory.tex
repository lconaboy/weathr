...
A key result of \cite{bjerknes1966} is that by using the above reasoning
...
reinforcing the initial SSTA. Through positive feedback between the ocean and
the atmosphere, an initial SSTA can lead the equatorial Pacific into a warm
state -- \elnino. Since the phenomenon is due to ocean-atmosphere interaction,
the whole system is termed the \elnino-Southern Oscillation. {}\nina\
corresponds to the cold state of ENSO, characterised by negative SSTAs and keen
trade winds.
