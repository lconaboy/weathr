...
\begin{figure*}
  ...
  \label{fig:allp}
\end{figure*}
Now that we have looked at the general distribution of pixels for a
single day, it is time to explore what these distributions look like
for a single pixel, as we use single pixels in our analysis. 
\begin{figure*}
  \centering
...
interesting point here is that the distribution changes from beingg
...
cloud fraction anomaies and WTIO SSTAs appear to closely follow the
