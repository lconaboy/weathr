...
\begin{titlepage}
  \begin{center}
    ...
    % \textsf{\textbf{\huge Investigating the response in African climate anomalies to the \elnino{}--Southern Oscillation} \par} \\
