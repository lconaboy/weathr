...
quote and cursory test were justification enough that we could, at
this time, take as constant the calibration values. Thus we chose for
the calibration values those shown in Table \ref{tab:calibration}.
...
\begin{align}
  \textrm{Radiance} = \textrm{Cal\_Offset} + \textrm{Cal\_Slope} \times
  \textrm{Pixel Count} \label{eqn:calibration}
\end{align}
